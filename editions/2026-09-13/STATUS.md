...
- **Nostalgia and the Village** (Laurel Baer) — via Annie. Not received. (Note: Judy's final list spells it "Laurel Baer", not "Baar" — update if confirmed.) Annie confirmed by email Sept 12 5:54 AM ET (`1a0942e724060d15`) that final drafts for DateBook and the Village article would be sent by noon — no text/attachments in that message yet.
