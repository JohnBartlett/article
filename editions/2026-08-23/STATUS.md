...
- **Post-publish text correction (2026-09-17, `1a0aee511c726a6d`):** Judy caught a misattributed quote in `murray-bay` — "My country is not a country it is winter" is credited to Gilles Vigneault, not Joni Mitchell. Fixed on dev2 (quote text itself unchanged, only the attribution). Live production (master) still has the old attribution — this fix needs staging/publish in a follow-up session to reach chicagoclassicmag.com.
