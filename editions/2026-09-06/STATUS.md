...
**Skeleton, nav chain, homepage, DateBook, and Astrochart are wired.** 4 of 9 articles are Ready (silvia-beltrametti-satire, francesco-bianchini, dr-ruth-gannon-cook, fill-the-stands). Edgelord added as 9th article (last in chain). Francesco tribute text received and placed. Marjorie Schwebel bio filled in. Remaining 5 articles still placeholder stubs.
...
9. `edgelord` — Edgelord (short story), by Scott Holleran [added Sept 4 per Judy's email `1a06c1265029bb88`]
...
| fill-the-stands | How Sweet It Is: Fill The Stands Gives Boost to Girls' Sports | David A. F. Sweet | ✅ Full text built (parallel session, Sept 2; nav fixed Sept 3) | ✅ 2/3 placed (`FTS 1.jpeg` hero, `FTS 3.jpeg` body) — `FTS 2.JPEG` pending, Google Drive permissions block automated download (msg `1a05d0c35428c573`) | About nonprofit Fill The Stands and founder Elizabeth Sweet. Verifies READY per `verify_edition.py` (2/3 photos is enough for Ready since at least one photo exists per convention — confirm with Judy whether Photo 2 is essential before publish). Nav updated Sept 4: next → edgelord (was homepage). |
| edgelord | Edgelord | Scott Holleran | ✅ Full short story built (msg `1a06c1265029bb88`, Sept 4) | ✅ 1/1 cover photo (`C19180E8-D1B0-4793-B30D-A2B0F84FF450 2.jpeg`, extracted from msg `1a06c10782e9ce20`) | Last article in chain (position 9). Judy's instruction: "make it the last article." Homepage card added. About.html Scott Holleran articles popup updated. |
...
- Nav chain order (hero → last): **silvia-beltrametti-satire** → francesco-bianchini → jafra-canaan-wellspring → rush-benefit → sounds-good-choir-river → dr-ruth-gannon-cook → tadoussac → fill-the-stands → **edgelord**
