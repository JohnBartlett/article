...
| 4 | rocky-mountaineer | Rocky Mountaineer Train Trip | Judy Carmack Bross | Ana | ⚠ stub | ❌ | Text + photos promised by Judy "by Wednesday" (Jul 8, msg 19f3bbdc2f0a09d4); folder + stub created Jul 10 (prep), inserted into nav chain between odyssey and kintsugi; no photo yet — thumb-placeholder.jpg used |
| 5 | kintsugi | Kintsugi (Jill Lowe's feature) | Jill Lowe | Emma | ⚠ stub | ✅ 15 files | `64) Kintsugi.pdf` + lead photo `shutterstock_2308896621.jpeg` (msg 19f376918ce0cf05) and 13 more files (msg 19f3769fe0b412b8) all on disk, incl. `Screenshot 2026-07-04 at 08.44.00.png` (book cover "Use the Good Dishes" by Dr. Elaine Dembe); no captions in email — check PDF; PDF article → build text first, get placement before placing photos (mistake #29); PDF not downloadable without Gmail credentials; stub built Jul 10 (prep) using lead shutterstock photo as hero |
