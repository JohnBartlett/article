...
**6 of 7 articles have full text and photos placed (5 fully ready, 1 with unconfirmed captions). 1 remains a pure stub.**
...
- Homepage hero and all cards except jill-lowe-hands now use real photos; jill-lowe-hands still uses `card-placeholder.jpg`.
