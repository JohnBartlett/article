...
**4 of 7 articles have full text placed (3 fully ready with photos, 1 with unconfirmed captions). 3 are stubs awaiting content.**
...
|------|-------|--------|------|--------|-------|
| nick-wilder-summer | Nick Wilder's Summer Photo Essay | Nick Wilder | Placeholder — cover only | Cover photo placed as hero: `IMG_0312.jpeg` (msg `19fd343a2081cc95`) | Essay text and remaining photos not sent yet. |
