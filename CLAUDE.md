...
27. **Not every article needs a hero photo at the top** — Reviews, opinion pieces, and columns may be better as text-led. Ask before placing an opening image if the article type is ambiguous. If unsure: build without a top photo, note it, and let the editor decide.
